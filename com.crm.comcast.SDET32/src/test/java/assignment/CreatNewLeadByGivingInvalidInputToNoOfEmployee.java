...
/**
 * This class contains create new lead by giving Invaild input to no of employee that a message popup of that
 * invalid no of employee
 * @author nikki
 *
 */
      ...
      int ramdomValue = random.nextInt(10000);
		...
		property.load(fis);
		 String BROWSER= property.getProperty("browser");
	       ...
	       driver.findElement(By.id("noofemployees")).sendKeys("ghhk");
