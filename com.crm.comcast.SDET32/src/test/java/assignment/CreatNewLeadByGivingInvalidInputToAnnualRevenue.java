...
/**
 * This class contains create new lead by giving invaild input to revenue that invaild massage to show
 * @author nikki
 *
 */
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException
	{
		...
		property.load(fis);
		 String BROWSER= property.getProperty("browser");
	       ...
	       driver.findElement(By.name("annualrevenue")).sendKeys("ydff");
